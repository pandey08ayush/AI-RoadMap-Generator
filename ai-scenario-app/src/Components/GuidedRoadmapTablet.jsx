        ...
        for (let i = 0; i < allCards.length; i += 2) {
            ...
            const row = (
                <div key={`row-${i}`} className="card-row-wrapper">
                        ...
                        {rowCards.map((card, index) => (
                            ...
                            <React.Fragment key={index}>
                                ...
                                {index < rowCards.length - 1 && (
                                    <div className={`progress-line-guided-view-all ${i === 0 && index === 0 ? 'green-progress' : ''}`}>
                                        <div className="progress-circle-guided-view-all" style={{ background: (i === 0 && index === 0) ? '#28a745' : '#F6F6F6' }}>
                                            <FaCheck style={{ color: (i === 0 && index === 0) ? '#fff' : '#E0E3E5', fontSize: '16px' }} />
                                        </div>
                                    </div>
                                )}
                                {index === rowCards.length - 1 && (
                    ...
                    {i % 4 === 0 && i + 2 < allCards.length && (
                        <div className="vertical-connector" style={{ position: 'relative' }}>
                            <svg
                                width="60"
                                height="270"
                                style={{ position: 'absolute', right: '-90px', top: '-99px' }}
                            >
                                <line
                                    x1="30"
                                    y1="0"
                    ...
                    {i % 4 === 2 && i + 2 < allCards.length && (
                        <div className="vertical-connector" style={{ position: 'relative' }}>
                            <svg
                                width="60"
                                height="270"
                                style={{ position: 'absolute', left: '-90px', top: '-99px' }}
                            >
                                <line
                                    x1="30"
                                    y1="0"
...
export default GuidedRoadmapViewAll2nd;
